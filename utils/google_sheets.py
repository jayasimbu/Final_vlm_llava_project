...
def save_to_sheet(data):
    ...
    try:
        ...
        row = [
            ...
            data.get("gst", "Not found"),
            data.get("tax", "Not found"),
            data.get("subtotal", "Not found"),
            data.get("discount", "Not found"),
            data.get("payment_method", "Not found"),
            data.get("billing_address", "Not found"),
            data.get("shipping_address", "Not found"),
